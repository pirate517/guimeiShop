...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll" id="left1">
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="layui-icon" target="iframe_context" href="/customer/customerPageList" style="color:#9FC105">&#xe770;&nbsp;&nbsp;顾客管理</a>
                    <dl class="layui-nav-child">
                        <!--a标签中写ifream的name 则点击超链接 就会在指定name的ifream中显示-->
                        <dd><a target="iframe_context"  href="/customer/customerPageList">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context" href="doSmallClass/query">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;商品管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doGoods/query">查询商品</a></dd>
                        <dd><a target="iframe_context" href="doGoods/localAddGoods">添加商品</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div id="main" class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <iframe name="iframe_context" frameborder="0" id="context" src="/customer/customerPageList"  ></iframe>
        </div>
    </div>
