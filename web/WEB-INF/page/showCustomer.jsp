...
<body>
<form action="/customer/unionListCustomer" method="post">
    <label>学号:</label>
            ...
            <table id="stu" width="90%" class="layui-table" lay-size="sm">
                ...
                <%--<c:forEach items="${sessionScope.Page.pageData}" var="cus">--%>
                    <tr>
                        ...
                        <td><a class="layui-btn layui-btn-sm" href="/customer/delById?id=${cus.id}">删除</a></td>
                        <td><a class="layui-btn layui-btn-sm" href="/customer/showCustomerById?id=${cus.id}">修改</a></td>
